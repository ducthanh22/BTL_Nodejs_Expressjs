...
const Rep = require('../repository/detail_warehouseRep');

class detail_WarehouseController {
    ...
    async getAll(_, res) {
      ...
      async create(req, res) {
        try {
          ...
          const ColorData = req.body.Detail_importbills;
          console.log(ColorData)
          const newColor = await Rep.createmany(ColorData);
          res.status(201).json({
      ...
      async Deletemany(req, res) {
        try {
          ...
          const ColorData = req.body.Detail_importbills;
          console.log(ColorData)
          const newColor = await Rep.Deletemany(ColorData);
          res.status(201).json({
...
module.exports = new detail_WarehouseController();
